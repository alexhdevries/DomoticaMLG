...
// By Sibbele Oosterhaven, Computer Science NHL, Leeuwarden ; Edited by Machiel Sterenborg
// V1.0, 13/12/2015
...
#define ledPin       13  // output, led used for "connect state": blinking = searching; continuously = connected
#define infoPin      9  // output, more information
#define analogPin    0  // sensor value

EthernetServer server(ethPort);              // EthernetServer instance (listening on port <ethPort>).
RCSwitch actionTransmitter = RCSwitch();  // Intantiate a new ActionTransmitter remote, old model, use pin <RFPin>
